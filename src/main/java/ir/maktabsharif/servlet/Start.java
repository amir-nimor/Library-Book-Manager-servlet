...
public class Start implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        Book book6 = new Book("The Hobbit", "J.R.R. Tolkien", "Fantasy", BigInteger.valueOf(220000));
        ...
        Book book9 = new Book("Pride and Prejudice", "Jane Austen", "Romance", BigInteger.valueOf(190000));
